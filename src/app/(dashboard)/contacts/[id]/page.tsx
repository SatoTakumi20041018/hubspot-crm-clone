  ...
  return (
    <div className="-m-6 flex flex-col" style={{ height: "calc(100vh - 4rem)" }}>
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 px-6 pt-3 pb-1 bg-white flex-shrink-0">
        <Link href="/contacts" className="hover:text-gray-700">コンタクト</Link>
              ...
              <Card>
                <CardContent className="p-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="rounded-lg bg-gray-50 p-3">
                      <p className="text-xs text-gray-500 mb-1">ライフサイクル</p>
                      <Badge
                        variant={
                          lifecycleStage === "CUSTOMER"
                            ? "success"
          ...
          {middleTab === "activities" && (
            <div>
              ...
              <div className="space-y-4">
                ...
                {/* Show notes in activities if filtered to notes and no activities found */}
        ...
        <div className="w-72 flex-shrink-0 overflow-y-auto border-l border-gray-200 bg-white p-4">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              ...
              {deals.length > 3 && (
                <Link href="/deals" className="block text-center text-xs text-[#ff4800] hover:underline py-1 mt-1">
                  すべて表示
                </Link>
              )}
            </div>
          ...
          {/* A3: Tickets with count header */}
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">
                関連チケット ({tickets.length})
              </h2>
              <button className="text-xs text-[#ff4800] hover:underline flex items-center gap-1" onClick={() => alert("関連レコードの追加は準備中です")}>
                <Plus className="h-3 w-3" />
                追加
