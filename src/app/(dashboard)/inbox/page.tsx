...
const conversations: Conversation[] = [
  {
    ...
    company: "田中商事株式会社",
    channel: "email",
    lastMessage: "見積書の件、確認いたしました。いくつか質問がございます。",
    status: "open",
    unread: true,
    time: "10分前",
    messages: [
      { sender: "田中 太郎", text: "お世話になっております。先日の打ち合わせの件でご連絡いたします。", time: "09:30", isAgent: false },
      { sender: "佐藤 匠", text: "ご連絡ありがとうございます。見積書をお送りいたします。", time: "10:15", isAgent: true },
      { sender: "田中 太郎", text: "見積書の件、確認いたしました。いくつか質問がございます。", time: "11:30", isAgent: false },
    ],
  },
  {
    id: "cv2",
    ...
    company: "鈴木テクノロジー",
    channel: "chat",
    lastMessage: "クラウド移行について詳しく教えていただけますか？",
    status: "open",
    unread: true,
    time: "30分前",
    messages: [
      { sender: "鈴木 花子", text: "こんにちは。クラウド移行について詳しく教えていただけますか？", time: "10:45", isAgent: false },
    ],
  },
  {
    id: "cv3",
    ...
    company: "ABC株式会社",
    channel: "form",
    lastMessage: "お問い合わせフォームから送信: CRM導入について相談したい",
    status: "open",
    unread: false,
    time: "1時間前",
    messages: [
      { sender: "山田 一郎", text: "CRM導入について相談したいです。現在のシステムからの移行を検討しています。", time: "09:00", isAgent: false },
      { sender: "佐藤 匠", text: "お問い合わせありがとうございます。詳しいヒアリングのため、お電話のお時間をいただけますでしょうか。", time: "09:30", isAgent: true },
    ],
  },
  {
    id: "cv4",
    ...
    channel: "email",
    lastMessage: "データ分析基盤のデモ日程を調整させてください。",
    status: "open",
    unread: false,
    time: "2時間前",
    messages: [
      { sender: "佐々木 美咲", text: "データ分析基盤のデモ日程を調整させてください。来週の火曜日は可能でしょうか？", time: "08:15", isAgent: false },
      { sender: "佐藤 匠", text: "来週火曜日10:00で調整可能です。Teamsでのデモでよろしいでしょうか？", time: "08:45", isAgent: true },
    ],
  },
  {
    id: "cv5",
    ...
    company: "東京マーケティング",
    channel: "chat",
    lastMessage: "料金プランについて教えてください。",
    status: "closed",
    unread: false,
    time: "3時間前",
    messages: [
      { sender: "高橋 健一", text: "料金プランについて教えてください。", time: "07:00", isAgent: false },
      { sender: "田村 愛", text: "こちらが料金プランの比較表です。ご質問があればお気軽にどうぞ。", time: "07:15", isAgent: true },
      { sender: "高橋 健一", text: "ありがとうございます。検討して改めてご連絡します。", time: "07:30", isAgent: false },
    ],
  },
  {
    id: "cv6",
    ...
    company: "イノベーション株式会社",
    channel: "email",
    lastMessage: "セキュリティ監査の報告書を送付いたします。",
    status: "open",
    unread: true,
    time: "4時間前",
    messages: [
      { sender: "佐藤 匠", text: "セキュリティ監査の報告書を送付いたします。ご確認ください。", time: "06:30", isAgent: true },
    ],
  },
  {
    id: "cv7",
    ...
    company: "グローバルシステム",
    channel: "email",
    lastMessage: "基幹システムの要件定義書のレビューをお願いします。",
    status: "open",
    unread: false,
    time: "昨日",
    messages: [
      { sender: "渡辺 大輔", text: "基幹システムの要件定義書のレビューをお願いします。添付ファイルをご確認ください。", time: "昨日 16:00", isAgent: false },
    ],
  },
  {
    id: "cv8",
    ...
    company: "フューチャーテック",
    channel: "form",
    lastMessage: "サポートリクエスト: UAT環境でのバグ報告",
    status: "closed",
    unread: false,
    time: "昨日",
    messages: [
      { sender: "小林 誠", text: "UAT環境でバグを見つけました。画面のスクリーンショットを添付します。", time: "昨日 14:00", isAgent: false },
      { sender: "佐藤 匠", text: "ご報告ありがとうございます。開発チームで確認し、本日中に修正いたします。", time: "昨日 14:30", isAgent: true },
      { sender: "佐藤 匠", text: "修正が完了しました。ご確認をお願いいたします。", time: "昨日 17:00", isAgent: true },
    ],
  },
];
...
export default function InboxPage() {
  ...
  const filtered = conversations.filter((c) => {
    ...
    const matchStatus =
      filterStatus === "すべて" ||
      (filterStatus === "オープン" && c.status === "open") ||
      (filterStatus === "クローズ" && c.status === "closed");
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-0 lg:grid-cols-3" style={{ height: "calc(100vh - 220px)" }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-0.5">
                      <span className={`text-sm ${conv.unread ? "font-semibold text-gray-900" : "font-medium text-gray-700"}`}>
                        {conv.contact}
                      </span>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge variant={selected.status === "open" ? "success" : "default"}>
                  {selected.status === "open" ? "オープン" : "クローズ"}
                </Badge>
              </div>
            </div>
          </div>
              ...
              <div key={i} className={`flex ${msg.isAgent ? "justify-end" : "justify-start"}`}>
                <div className={`max-w-[70%] rounded-lg p-3 ${
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`text-xs font-medium ${msg.isAgent ? "text-white/80" : "text-gray-500"}`}>
                      {msg.sender}
                    </span>
                    <span className={`text-[10px] ${msg.isAgent ? "text-white/60" : "text-gray-400"}`}>
                      {msg.time}
                    </span>
                  </div>
